...
struct GetProgramsListResponse_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::dnb_msgs::Program_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::dnb_msgs::Program_<ContainerAllocator> >::other >  _programs_type;
