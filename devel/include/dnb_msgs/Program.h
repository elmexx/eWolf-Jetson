...
struct Program_
{
  ...
  _name_type name;
   ...
   typedef std::vector< ::dnb_msgs::Argument_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::dnb_msgs::Argument_<ContainerAllocator> >::other >  _arguments_type;
