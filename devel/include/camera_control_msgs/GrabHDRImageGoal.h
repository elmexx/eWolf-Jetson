...
bool operator==(const ::camera_control_msgs::GrabHDRImageGoal_<ContainerAllocator1> & lhs, const ::camera_control_msgs::GrabHDRImageGoal_<ContainerAllocator2> & rhs)
{
  return lhs.exposure_given == rhs.exposure_given &&
    lhs.exposure_times == rhs.exposure_times &&
    lhs.exposure_fixed == rhs.exposure_fixed &&
