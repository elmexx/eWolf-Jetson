...
bool operator==(const ::camera_control_msgs::GrabHDRImageAction_<ContainerAllocator1> & lhs, const ::camera_control_msgs::GrabHDRImageAction_<ContainerAllocator2> & rhs)
{
