...
bool operator==(const ::camera_control_msgs::GrabHDRImageActionResult_<ContainerAllocator1> & lhs, const ::camera_control_msgs::GrabHDRImageActionResult_<ContainerAllocator2> & rhs)
{
