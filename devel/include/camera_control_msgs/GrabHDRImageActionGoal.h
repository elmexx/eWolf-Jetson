...
bool operator==(const ::camera_control_msgs::GrabHDRImageActionGoal_<ContainerAllocator1> & lhs, const ::camera_control_msgs::GrabHDRImageActionGoal_<ContainerAllocator2> & rhs)
{
