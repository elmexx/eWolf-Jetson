...
bool operator==(const ::camera_control_msgs::GrabAndSaveImageGoal_<ContainerAllocator1> & lhs, const ::camera_control_msgs::GrabAndSaveImageGoal_<ContainerAllocator2> & rhs)
{
  return lhs.exposure_given == rhs.exposure_given &&
    lhs.exposure_time == rhs.exposure_time &&
    lhs.gain_given == rhs.gain_given &&
    lhs.gain_value == rhs.gain_value &&
    lhs.gamma_given == rhs.gamma_given &&
    lhs.gamma_value == rhs.gamma_value &&
    lhs.brightness_given == rhs.brightness_given &&
    lhs.brightness_value == rhs.brightness_value &&
    lhs.exposure_auto == rhs.exposure_auto &&
    lhs.gain_auto == rhs.gain_auto &&
    lhs.img_storage_path_and_name == rhs.img_storage_path_and_name;
}
