...
bool operator==(const ::camera_control_msgs::GrabAndSaveImageResult_<ContainerAllocator1> & lhs, const ::camera_control_msgs::GrabAndSaveImageResult_<ContainerAllocator2> & rhs)
{
