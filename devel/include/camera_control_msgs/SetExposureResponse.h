...
bool operator==(const ::camera_control_msgs::SetExposureResponse_<ContainerAllocator1> & lhs, const ::camera_control_msgs::SetExposureResponse_<ContainerAllocator2> & rhs)
{
  return lhs.reached_exposure == rhs.reached_exposure &&
