...
bool operator==(const ::camera_control_msgs::GrabAndSaveImageAction_<ContainerAllocator1> & lhs, const ::camera_control_msgs::GrabAndSaveImageAction_<ContainerAllocator2> & rhs)
{
