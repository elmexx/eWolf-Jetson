...
bool operator==(const ::camera_control_msgs::GrabAndSaveImageActionGoal_<ContainerAllocator1> & lhs, const ::camera_control_msgs::GrabAndSaveImageActionGoal_<ContainerAllocator2> & rhs)
{
