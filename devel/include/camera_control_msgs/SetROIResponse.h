...
bool operator==(const ::camera_control_msgs::SetROIResponse_<ContainerAllocator1> & lhs, const ::camera_control_msgs::SetROIResponse_<ContainerAllocator2> & rhs)
{
  return lhs.reached_roi == rhs.reached_roi &&
...
struct Definition< ::camera_control_msgs::SetROIResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Exact match can not always reached\n"
