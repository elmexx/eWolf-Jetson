...
class image_detect:
    ...
    def callback(self, ros_data):
        ...
        image_jetson = jetson.utils.cudaFromNumpy(np_arr)
        ...
        (kps, descs) = sift.detectAndCompute(cv2.cvtColor(image_np, cv2.COLOR_BGR2GRAY), None)         
        ...
        image_fe = cv2.drawKeypoints(image_np, kps, None, color=(0,0,255))
        
        cv2.imshow('cv_img', image_fe)
        cv2.waitKey(2)
